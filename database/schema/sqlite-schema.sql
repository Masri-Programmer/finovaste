...
CREATE UNIQUE INDEX "component_items_translation_key_unique" on "component_items" ("translation_key");
...
CREATE INDEX "transactions_payable_type_payable_id_index" on "transactions" ("payable_type", "payable_id");

CREATE UNIQUE INDEX "transactions_uuid_unique" on "transactions" ("uuid");

CREATE UNIQUE INDEX "transactions_transaction_ref_unique" on "transactions" ("transaction_ref");
...
CREATE UNIQUE INDEX "subscription_items_stripe_id_unique" on "subscription_items" ("stripe_id");
...
CREATE UNIQUE INDEX "listing_subscriptions_listing_id_email_unique" on "listing_subscriptions" ("listing_id", "email");
...
VALUES (
        5,
        '2025_10_21_113424_create_components_table',
        1
    );
...
VALUES (
        6,
        '2025_10_21_113426_create_component_items_table',
        1
    );
...
VALUES (
        7,
        '2025_10_21_131203_create_categories_table',
        1
    );
...
VALUES (
        8,
        '2025_10_21_132201_create_addresses_table',
        1
    );
...
VALUES (
        9,
        '2025_10_21_132229_add_address_id_to_users_table',
        1
    );
...
VALUES (
        10,
        '2025_10_21_135452_create_investment_listings_table',
        1
    );
...
VALUES (
        11,
        '2025_10_21_135707_create_listings_table',
        1
    );
...
VALUES (
        12,
        '2025_10_21_140305_create_purchase_listings_table',
        1
    );
...
VALUES (
        13,
        '2025_10_21_140330_create_auction_listings_table',
        1
    );
...
VALUES (
        14,
        '2025_10_21_140349_create_donation_listings_table',
        1
    );
...
VALUES (
        15,
        '2025_10_21_140940_create_reviews_table',
        1
    );
...
VALUES (
        16,
        '2025_11_02_112833_create_telescope_entries_table',
        1
    );
...
VALUES (
        17,
        '2025_11_02_141300_create_media_table',
        1
    );
...
VALUES (
        18,
        '2025_11_10_123742_create_listing_user_table',
        1
    );
...
VALUES (
        19,
        '2025_11_15_162307_create_permission_tables',
        1
    );
...
VALUES (
        20,
        '2025_11_15_174407_create_settings_table',
        1
    );
...
VALUES (
        21,
        '2025_11_15_174449_create_default_general_settings',
        1
    );
...
VALUES (
        22,
        '2025_11_21_191039_create_bids_table',
        1
    );
...
VALUES (
        23,
        '2025_11_21_191301_create_transactions_table',
        1
    );
...
VALUES (
        24,
        '2025_11_23_160034_create_listing_faqs_table',
        1
    );
...
VALUES (
        25,
        '2025_11_26_192703_create_notifications_table',
        1
    );
...
VALUES (
        26,
        '2025_11_26_192716_add_notification_settings_to_users_table',
        1
    );
...
VALUES (
        27,
        '2025_12_01_175519_create_customer_columns',
        1
    );
...
VALUES (
        28,
        '2025_12_01_175520_create_subscriptions_table',
        1
    );
...
VALUES (
        29,
        '2025_12_01_175521_create_subscription_items_table',
        1
    );
...
VALUES (
        30,
        '2025_12_01_175522_add_meter_id_to_subscription_items_table',
        1
    );
...
VALUES (
        31,
        '2025_12_01_175523_add_meter_event_name_to_subscription_items_table',
        1
    );
...
VALUES (
        32,
        '2025_12_01_175806_create_listing_subscriptions_table',
        1
    );
...
VALUES (
        33,
        '2025_12_01_180549_create_listing_updates_table',
        1
    );
...
VALUES (
        34,
        '2025_12_01_182639_add_localization_to_subscriptions_and_updates',
        1
    );